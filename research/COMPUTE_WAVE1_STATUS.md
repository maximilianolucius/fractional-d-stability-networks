...
| P2 HP | DONE — 56,234/56,234 consistent; control artefacts rechecked (0 genuine); VERDICT COMPUTE_PASS | `p2_hp_verify.py`, `p2_hp_controls.py`, `p2_hp_recheck.py`, `p2_c5_lemma2_witness.py`, `p2_finalize_summary.py` | C10_STRESS_SUMMARY.json, C10_WORST_CASES.csv |
...
| Final report | DONE | | research/COMPUTE_WAVE1_FINAL_REPORT.md |
