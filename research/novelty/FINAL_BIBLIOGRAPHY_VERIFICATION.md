...
| O. Y. Kushel and R. Pavani, **“The problem of generalized D-stability in unbounded LMI regions and its computational aspects,”** later *Journal of Dynamics and Differential Equations* | **A** | Definitions use every positive diagonal multiplier. The forbidden-boundary theorem gives region-D-stability iff initial region stability plus boundary avoidance over all D. **the conic/complement equivalence theorem (Theorem 6 in the accessible preprint, Section 3.2; verify published theorem numbering before submission) explicitly treats a conic region and the complement of the closed conic region**, with equivalent determinant nonvanishing conditions for every positive diagonal D. | **Closest abstract predecessor to C-10.** After B=-A, the α<1 Matignon problem is a complement-of-cone generalized-D-stability problem. C-10 is not the first N&S criterion; its surviving novelty is explicit real-3×3 elimination to κ<T_α(β). | DOI: 10.1007/s10884-020-09891-y; arXiv:2004.11172 |
...
- **known:** abstract N&S forbidden-boundary theorem for conic region/complement under all D (Kushel–Pavani the conic/complement equivalence theorem (Theorem 6 in the accessible preprint, Section 3.2; verify published theorem numbering before submission));
