...
\]
rather than by the left half-plane; see, for example, the modern treatment in \citet{BrandiburGarrappaKaslik2021}. Fixed-polynomial fractional root-location criteria are well developed \citep{CermakNechvatal2017,Bourafa2020}, and structured cyclic networks admit fractional secant conditions \citep{Siami2021}. What is not supplied by these results is an explicit elimination of the universal positive-diagonal multiplier for a generic real \(3\times3\) matrix in the full Matignon reflex sector.
