...
\begin{proof}
Permutation symmetry and uniqueness force \(x^*\) to be the simplex center. Substitution gives the first identity; the second simplifies to the \(n=3\) single-cycle threshold of \citet{Siami2021}.
\end{proof}
