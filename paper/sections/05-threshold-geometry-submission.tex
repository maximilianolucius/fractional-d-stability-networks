...
\begin{proof}
Permutation symmetry and uniqueness force \(x^*\) to be the simplex center. Substitution gives the first identity; the second simplifies to the \(n=3\) single-cycle threshold of \cite{Siami2021}.
\end{proof}
...
\includegraphics[width=\linewidth]{panel05_threshold_ratio.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}\centering
\includegraphics[width=\linewidth]{panel06_relative_width.pdf}
\end{minipage}

\begin{minipage}[t]{0.48\linewidth}\centering
\includegraphics[width=\linewidth]{panel07_classical_asymptotic.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}\centering
\includegraphics[width=\linewidth]{panel08_low_order.pdf}
\end{minipage}
\caption{Order dependence of the exact threshold. (a) Fractional enlargement \(T_\alpha/T_1\). (b) Relative width of the genuinely fractional band. (c) High-precision verification of the classical-order coefficient in Theorem~\ref{thm:C14}. (d) Low-order normalization \(T_\alpha K^3/27\to1\), included as an independently verified secondary asymptotic.}
\label{fig:threshold-multipanel}
\end{figure}
