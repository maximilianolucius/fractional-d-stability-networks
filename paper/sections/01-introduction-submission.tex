...
This is an exact low-dimensional result within generalized D-stability, not a new definition. The abstract all-diagonal forbidden-boundary framework is due to \cite{KushelPavani2022}; here the diagonal multiplier is eliminated explicitly for the generic real three-dimensional Matignon problem. The symmetric slice recovers the single-cycle result of \cite{Siami2021}.
