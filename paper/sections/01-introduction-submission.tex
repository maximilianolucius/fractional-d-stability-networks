...
The contribution is an explicit low-dimensional solution within the known generalized-D-stability framework, not a new definition of fractional D-stability. In particular, \citet{KushelPavani2022} provide an abstract all-diagonal forbidden-boundary framework, while our contribution is the exact elimination of the diagonal multiplier in the generic real three-dimensional Matignon problem. The symmetric slice recovers the single-cycle result of \citet{Siami2021}, rather than replacing it.
