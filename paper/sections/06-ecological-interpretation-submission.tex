...
\begin{figure}[t]
\centering
\includegraphics[width=.82\linewidth]{fig_ecological_band.pdf}
\caption{Cain and fractional loop-space boundaries for \(\beta=(3,0.5,1)\). The shaded interval between the dashed Cain boundary and the solid fractional boundary is the genuinely fractional region; the ordinate is logarithmic.}
