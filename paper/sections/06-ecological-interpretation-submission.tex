\section{Ecological feedback coordinates}
\label{sec:ecology}

For the commensurate fractional generalized Lotka--Volterra system
\[
{}^C D_t^\alpha x_i
=
...
\]
The results below concern local Jacobian stability. Principal-minor and cycle decompositions are classical in ecological stability analysis \citep{ClarkHallam1982,Kinkhabwala2015}; the point here is that the exact fractional all-diagonal boundary can be written directly in those coordinates.
